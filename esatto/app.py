...
def main() -> None:
    ...
    patient_repo.create_table("id integer primary key auto_increment, first_name varchar(20) not null, last_name varchar(20) not null, PESEL varchar(20) not null")
    address_repo.create_table("id integer primary key auto_increment, street varchar(50) not null, city varchar(50) not null, zip_code varchar(6) not null, foreign key (patient_id) references patients(id) on delete cascade on update cascade")
